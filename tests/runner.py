...
TIMEOUT = int(environ.get('MATAM_TESTER_TEST_TIMEOUT', '60'))  # 1 second
VALGRIND_TIMEOUT = int(environ.get('MATAM_TESTER_VALGRIND_TIMEOUT', '120'))  # 2 seconds
...
RUN_MULTI_THREAD = int(environ.get('MATAM_TESTER_RUN_MULTI_THREADED', '1')) == 1
